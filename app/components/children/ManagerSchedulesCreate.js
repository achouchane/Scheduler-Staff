...
var ManagerSchedulesCreate = React.createClass({
  ...
  handleUpdateEmpSchedule: function (event) {
    ...
    saveButtonBlue.className =
      "btn btn-small waves-effect waves-light green accent-3";

    if (this.state.selectedEmpSchedule !== "") {
      helpers.updateEmpSchedule(this.state.selectedEmpSchedule).then(
        function (response) {
          var empName =
            this.state.selectedEmpSchedule.firstName +
            " " +
            this.state.selectedEmpSchedule.lastName +
            "'s ";
    ...
    let updatedEmpSchedules = this.state.empSchedules.map((empSchedule, j) => {
      if (i === j) {
        ...
        saveButton.className =
          "btn btn-small waves-effect waves-light blue accent-3";
                ...
                {this.state.empSchedules.map(function (schedules, i) {
                  return (
                    <tr key={i}>
                      <td
                        className="fullName"
                        id={this.state.empSchedules[i]._id}
                      >
                      ...
                      <td>
                        <button
                          ...
                          onClick={this.handleUpdateEmpSchedule.bind(this, i)}
                          className="btn btn-small waves-effect waves-light green accent-3"
                        >
                          Add
                        </button>
                      </td>
                      <td>
                        <button
                          id={i}
                          className="clearSchedule"
                          onClick={this.handleClearEmpSchedule.bind(this, i)}
                          className="btn btn-small waves-effect waves-light green accent-3"
                        >
                          Clear
                        </button>
